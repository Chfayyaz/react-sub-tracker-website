            ...
            <div className='row'>
                ...
                <div className='col-12 col-lg-6 '>
                    <div className=' m-lg-5 border bg-white  p-2 p-md-5 my-2'>
                        ...
                        <h4 className='fs-25 fw-600 mt-3 mt-lg-5 text-center'>Create an Account</h4>
                        ...
                        <Form>
                            ...
                            <FormGroup check inline className='mt-3 mb-2'>
                                ...
                                <Label check className='fs-13 fw-500 mb-2'>
                                    By proceeding, you agree to our <Link to="/privacy-policy" className='dark-purple'>Privacy Policy</Link>  and <Link to="/term-of-services" className='dark-purple'>Term of Use.</Link>
                                </Label>
                            </FormGroup>
                            <div className="d-grid gap-3">
                                <Button type='button' className=' fw-500 fs-15  btn-fill-color border-1 border-white py-2'  > Sign Up</Button>
                                <Button type='button' className=' fw-500 fs-15 py-2 text-dark btn-fill-light-outline'  > <img src={google} width={20} height={20} alt='icon' className='me-1' /> Sign In with Google</Button>
                                <Button type='button' className=' fw-500 fs-15   border-0 py-2' color="dark"  ><img src={apple} width={20} height={20} alt='icon' className='me-1' /> Sign In with Apple</Button>
