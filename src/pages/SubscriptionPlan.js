  ...
  return (
    <>
      ...
      <div className="row bg-white border rounded">
        <div className="col-12 col-lg-6 px-0 mx-0">
          ...
          <div className="px-lg-5 px-md-4 px-3 py-0 py-md-4 pb-3 pb-0">
            ...
            <div className="">
              <div className="d-flex gap-2 pt-3">
                ...
                <p className='fs-12 fw-600'>Advanced Subscription <br /> Management</p>
              </div>
              <div className="d-flex gap-2">
                <span className=""><img src={checkLight} className="img-fluid me-2" width="24" alt="" /></span>
                <p className='fs-12 fw-600'>Customizable Alerts and <br />Notifications</p>
              </div>
              <div className="d-flex gap-2">
                <span className=""><img src={checkLight} className="img-fluid me-2" width="24" alt="" /></span>
                <p className='fs-12 fw-600'>Comprehensive financial <br /> Reporting</p>
              </div>
              <div className="d-flex gap-2 mb-4">
                <span><img src={checkLight} className="img-fluid me-2" alt="" /></span>
                <p className="mt-1 fs-12 fw-600">Priority Support</p>
              </div>
        ...
        <div className="col-12 col-lg-6 px-0 mx-0  subscriptionBgImg rounded">
          <div className="px-lg-5 px-md-4 px-3 pt-3 pt-md-5 pb-0 mt-5 mt-md-0">
            ...
            <div className="d-flex flex-column justify-content-between">
              <div className="d-flex gap-2 pt-4">
                ...
                <p className='fs-12 fw-600 text-white'>Advanced Subscription Management</p>
              </div>
              <div className="d-flex gap-2">
                <span className=""><img src={checkDark} className="img-fluid me-2" width="24" alt="" /></span>
                <p className='fs-12 fw-600 text-white'>Customizable Alerts and Notifications</p>
              </div>
              <div className="d-flex gap-2">
                <span className=""><img src={checkDark} className="img-fluid me-2" width="24" alt="" /></span>
                <p className='fs-12 fw-600 text-white'>Comprehensive financial Reporting</p>
              </div>
              <div className="d-flex gap-2">
                <span><img src={checkDark} className="img-fluid me-2" width="24" alt="" /></span>
                <p className='fs-12 fw-600 text-white'>Priority Support</p>
              </div>
              <div className='my-3'>
